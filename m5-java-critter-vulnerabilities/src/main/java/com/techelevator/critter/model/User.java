...
public class User {
	...
	@Pattern.List({ //we cant have more than 1 pattern but we can group them as one under Pattern List 
	...
	@Pattern(regexp=".*[+=-+_{}*&%].*", message="Must have a number") //symbols need to be explicitly stated
	})

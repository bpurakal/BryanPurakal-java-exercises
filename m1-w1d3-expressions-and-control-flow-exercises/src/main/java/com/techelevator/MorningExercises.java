...
public class MorningExercises {
	 ...
	 * beginning and at the end. What's the difference? Where can I add a ++ to make
	 * the result equal 5?
	 */
	...
	/*
	 * 15. Write an if statement that returns "Fizz" if the parameter is 3 and
	...
	/*
	 * 16. Now write the above using the Ternary operator ?:. If you're not sure
	...
	/*
	 * 17. Write an if/else statement that returns "Fizz" if the parameter is 3,
	...
	/*
	 * 18. Write an if statement that checks if the parameter number is either equal
	...
	/*
	 * 20. Now, do it again with a different boolean operation. This time, the
	 * values are reversed.
	 */

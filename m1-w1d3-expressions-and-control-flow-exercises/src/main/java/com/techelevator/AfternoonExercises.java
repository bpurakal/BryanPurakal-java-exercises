...
public class AfternoonExercises {
	 ...
	 * "date" is the stylishness of your date's clothes. The result getting the
	 ...
	 * Otherwise the result is 1 (maybe). dateFashion(5, 10) → 2 dateFashion(5, 2) →
	 * 0 dateFashion(5, 5) → 1
	 */
	 ...
	 */
	/*
	 * public String alarmClock(int day, boolean vacation) { if ((day != 0 || day
	 * !=6) && !vacation) { return "7:00";} else if ((day != 0 || day !=6) &&
	 * vacation) { return "10:00";} else if((day== 0 || day==6) && !vacation) {
	 * return "10:00";} else { return "off";} }
	 */
	...
	public boolean nearTen(int num) {
		if ((num%10==2 || num%10==1 || num%10==0 || (num+2)%10==0 || (num+1)%10==0)) {
			return true;
		}else {
			return false;
		}
